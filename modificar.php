...
<html lang="en">
    ...
    <body>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="prenda" placeholder="Prenda" value="<?php echo "$tipo_prenda"; ?>"> /dentro del value ponemos el dato que que trajimos del egistro para que ya aparezca el el imput y no volver aq escribirlo
            <label>Marca</label>
        ...
        if(array_key_exists('guardar_cambios',$_POST)){
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE prendas SET prenda='$prenda', marca='$marca', talle='$talle', precio='$precio', imagen='$imagen' WHERE id =$id";
